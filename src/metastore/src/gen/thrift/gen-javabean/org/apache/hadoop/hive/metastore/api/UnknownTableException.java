...
public class UnknownTableException extends Exception implements TBase<UnknownTableException, UnknownTableException._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("UnknownTableException");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(UnknownTableException.class, metaDataMap);
  }
   ...
   */
  public UnknownTableException(UnknownTableException other) {
    if (other.isSetMessage()) {
      this.message = other.message;
    }
  }

  public UnknownTableException deepCopy() {
    return new UnknownTableException(this);
  }
