...
public class UnknownDBException extends Exception implements TBase<UnknownDBException, UnknownDBException._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("UnknownDBException");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(UnknownDBException.class, metaDataMap);
  }
   ...
   */
  public UnknownDBException(UnknownDBException other) {
    if (other.isSetMessage()) {
      this.message = other.message;
    }
  }

  public UnknownDBException deepCopy() {
    return new UnknownDBException(this);
  }
